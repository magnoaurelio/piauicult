 ...
 */
class PrefeitoFormWin extends TWindow {
    ...
    public function __construct($param) {
        ...
        parent::__construct();
        parent::setTitle("Prefeito - Vice");
        parent::setSize(1366,728);
       ...
       $this->form = new TQuickForm('form_Prefeito');
        ...
        $prepartidop =  new TDBCombo('prepartidop','conexao','Partido','parcodigo',['parcodigo','parsigla','parnome']);
        ...
        $lista = TButton::create('lista', array('PrefeitoList', 'onReload'), 'Voltar para a Listagem', 'bs:list green');
        ...
        $prefotop->setParametros($path,'FOTOP_'.$nome_arquivo,$permite); 
        $prefotoc->setParametros($path,'FOTOC_'.$nome_arquivo,$permite);
    ...
    public function onSave($param) {
        try {
            ...
            TApplication::loadPage('DiretoriaForm', 'onPrefeitoResult', $param); 
   ...
   public function onCancelar() {
      TApplication::loadPage($this->DADOS['page'], null, (array) $this->DADOS); 
   }
