...
class DiscoArte extends TPage
{
    ...
    public function __construct()
    {
        ...
        $inscodigo = new \Adianti\Widget\Wrapper\TDBCombo('artcodigo','conexao','Artista','artcodigo','{artusual}-{artcodigo}','artusual');
        ...
        $this->form->addQuickAction('Adicionar Arte', new TAction(array($this, 'onSearch')), 'fa:save green');
 ...
 // criar na grade um ordenação nome
        ...
        $container->add(TPanelGroup::pack('Disco (Arte) -  Disco: <b><span id="artnome"><span></b>', $this->form));
