 ...
 */
class ArtistaInstrumentoList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Artista (Instrumento) -  Artista: <b><span id="artnome"><span></b>');
    ...
    //    $insfoto = new Adianti\Widget\Form\TEntry('insfoto');
     ...
     function onLoad($param){
        TSession::setValue('artcodigo',$param['artcodigo']);
        $this->onReload();
    }
