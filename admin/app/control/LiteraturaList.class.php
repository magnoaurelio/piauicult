...
class LiteraturaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $column_litcatnome = new TDataGridColumn('literatura_Categoria->litcatnome', 'Categoria', 'left');
  ...
  // var_dump($column_litarquivo);
        $column_litarquivo->setTransformer( function($value, $object, $row) {
          ...
          $img->src = "files/literatura/paginas/".$value;
    ...
    public function onSearch()
    {
        ...
        if (isset($data->litcodigo) AND ($data->litcodigo)) {
            ...
            TSession::setValue('LiteraturaList_filter_litcodigo',   $filter); // stores the filter in the session
        }
        ...
        TSession::setValue('Literatura_filter_data', $data);
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Literatura
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            TTransaction::open('conexao'); // open a transaction with database
            $object = new Literatura($key, FALSE); // instantiates the Active Record
