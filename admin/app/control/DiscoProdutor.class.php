 ...
 */
class DiscoProdutor extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->addQuickAction('Adicionar Produtor', new TAction(array($this, 'onSearch')), 'fa:save green');
