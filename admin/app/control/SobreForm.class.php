...
class SobreForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        // creates the form
        $this->form = new TQuickForm('form_Sobre');
        ...
        $container->add(TPanelGroup::pack('Sobre PiauíCult', $this->form));
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new Sobre;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
                ...
                TTransaction::open('conexao'); // open a transaction
                $object = new Sobre($key); // instantiates the Active Record
