...
class BandaForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle('Grupo Cadastro');
        ...
        $this->form->addQuickField('Tipo de Grupo Musical', $bantipocodigo,  300 );
        ...
        $container->add(TPanelGroup::pack('Banda Form', $this->form));
