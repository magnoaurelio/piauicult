...
class SystemUserForm extends TPage
{
    ...
    function __construct()
    {
        ...
        $foto                = new TFile('foto');
        $unit_id             = new TDBCombo('artcodigo','conexao','Artista','artcodigo','artusual','artusual');
        ...
        $equipe = new TCombo('equipe');        
        $equipe->addItems(["N"=>"NÃO","S"=>"SIM"]);
        ...
        $foto->setParametros($path,'FOTO_'.$nome_arquivo,$permite); 
        ...
        $this->form->addFields( [new TLabel(_t('Name'))], [$name] ,  [new TLabel('Usual')], [$usual]);
        $this->form->addFields( [new TLabel('Foto')], [$foto] ,  [new TLabel('Prefeitura/Empresa')], [$empresa]);
        $this->form->addFields( [new TLabel('')] , [new TLabel('')],  [new TLabel('Contato')], [$contato]);
        $this->form->addFields( [new TLabel(_t('Login'))], [$login],  [new TLabel(_t('Email'))], [$email]);
        $this->form->addFields( [new TLabel("Artista")], [$unit_id],  [new TLabel(_t('Front page'))], [$frontpage_id, $frontpage_name] );
        $this->form->addFields( [new TLabel(_t('Password'))], [$password],  [new TLabel(_t('Password confirmation'))], [$repassword] );        $this->form->addFields( [new TLabel('Equipe')] , [$equipe],  [new TLabel('Função')], [$funcao]);
        $this->form->addFields( [new TLabel('')] , [new TLabel('')],  [new TLabel('Descrição')], [$descricao]);
