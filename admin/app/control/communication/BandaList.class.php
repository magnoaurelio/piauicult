...
class BandaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $column_banmusicos = new TDataGridColumn('banmusicos', 'Banmusicos', 'left');
        $column_banfoto1 = new TDataGridColumn('banfoto1', 'Banfoto1', 'left');
        $column_banfoto2 = new TDataGridColumn('banfoto2', 'Banfoto2', 'left');
        $column_banfoto3 = new TDataGridColumn('banfoto3', 'Banfoto3', 'left');
        $column_banfoto4 = new TDataGridColumn('banfoto4', 'Banfoto4', 'left');
        $column_banfoto5 = new TDataGridColumn('banfoto5', 'Banfoto5', 'left');
        $column_bandetalhe = new TDataGridColumn('bandetalhe', 'Bandetalhe', 'left');
