 ...
 */
class MusicaAutorList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Artistas (AUTORES / COMPOSITORES) -  Música: <b><span id="musnome"><span></b>');
        ...
        $this->form->addQuickAction('Adicionar Autor', new TAction(array($this, 'onSearch')), 'fa:save green');
        ...
        $container->add(TPanelGroup::pack('Artistas (AUTORES / COMPOSITORES) -  Música: <b><span id="musnome"><span></b>', $this->form));
