 ...
 */
class MusicaArtistaList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Artista (INTERPRETES) -  Música: <b><span id="musnome"><span></b>');
        ...
        $this->form->addQuickAction('Adicionar Interprete', new TAction(array($this, 'onSearch')), 'fa:save green');
        ...
        $column_artnome = new TDataGridColumn('artnome', 'Nome Música', 'left');
        ...
        $container->add(TPanelGroup::pack('Artista (INTERPRETES) -  Música: <b><span id="musnome"><span></b>', $this->form));
