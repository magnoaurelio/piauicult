 ...
 */
class VideoArtistaList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Video (Participante) -  Video: <b><span id="artnome"><span></b>');
 ...
 // criar na grade um ordenação nome
    ...
    public function onSearch($param)
    {
       TTransaction::open('conexao');
        ...
        $video->addArtistaSave($param['artcodigo']);
       TTransaction::close();
       $this->onReload();
    }
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            if( $video->getArtistas() ) {
                // iterate the collection of active records
                foreach ($video->getArtistas() as $object)
                {
            ...
            $count= sizeof($video->getArtistas());
    ...
    public function onDelete($param)
    {
        TTransaction::open('conexao');
        $video =  new Videos(TSession::getValue('vidcodigo'));
        $video->removeArtistaSave($param['artcodigo']);
       TTransaction::close();
       $this->onReload();
    }
