...
class BandaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Grupo / Bandas Listagem');
        
      
                // create the form fields
      //  $bannome = new TEntry('bannome');
        $bannome = new TDBCombo('bannome','conexao','Banda','bannome','{bannome} - {bancodigo}','bannome');
        
        
        $bannome->enableSearch();

        // add the fields
        $this->form->addQuickField('Nome', $bannome,  400 );
        ...
        $column_banfoto1->setTransformer( function($value, $object, $row) {
        ...
        $column_banfoto2->setTransformer( function($value, $object, $row) {
            $img  = new TElement('img');
            $img->src = "files/bandas/".$value;
           // $img->title = $object->artusual;
         ...
         $column_banfoto3->setTransformer( function($value, $object, $row) {
            $img  = new TElement('img');
            $img->src = "files/bandas/".$value;
           // $img->title = $object->artusual;
            $img->style = "width:90px; height:60px;";
         ...
         $column_banfoto4->setTransformer( function($value, $object, $row) {
            $img  = new TElement('img');
            $img->src = "files/bandas/".$value;
           // $img->title = $object->artusual;
            $img->style = "width:90px; height:60px;";
         ...
         $column_banfoto5->setTransformer( function($value, $object, $row) {
            $img  = new TElement('img');
            $img->src = "files/bandas/".$value;
           // $img->title = $object->artusual;
            $img->style = "width:90px; height:60px;";
        ...
        $container->add(TPanelGroup::pack('Grupo Listagem', $this->form));
