...
class NoticiasList extends TPage
{
    ...
    public function __construct()
    {
      ...
      //  $nottitulo = new TEntry('nottitulo');
        $nottitulo = new TDBCombo('nottitulo','conexao','Noticias','notid','nottitulo','nottitulo');
    ...
    //    $artcodigo = new TEntry('artcodigo');
        ...
        $column_notfoto = new TDataGridColumn('notfoto', 'Notfoto', 'left');
