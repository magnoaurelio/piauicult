...
class MusicaForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $musautor =  new TDBCombo('musautor','conexao','Artista','artcodigo','artnome','artnome');
        $artcodigo = new TDBCombo('artcodigo','conexao','Artista','artcodigo','artnome','artnome');
        $gencodigo = new TDBCombo('gencodigo','conexao','Genero','gencodigo','gennome','gennome');
        $musfaixa = new TEntry('musfaixa');
        $musbanda = new TDBCombo('musbanda','conexao','Disco','discodigo','disnome','disnome');
        ...
        $this->form->addQuickField('Data', $musdata,  100 );
        ...
        $this->form->addQuickField('Disco', $musbanda,  300 );
