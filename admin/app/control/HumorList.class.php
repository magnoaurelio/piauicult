...
class HumorList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->addFields( [ new TLabel('Nº Pag') ], [ $humpagina ] );
        ...
        $column_humpagina = new TDataGridColumn('humpagina', 'Nº Pag', 'left', 100);
        $column_humnome = new TDataGridColumn('humnome', 'Nome_Desenho', 'left', 100);
        ...
        $column_humarquivo = new TDataGridColumn('humarquivo', 'Desenho', 'left');
        $column_humsobre = new TDataGridColumn('humsobre', 'Sobre', 'left');
     
  // var_dump($column_humarquivo);
        ...
        $this->datagrid->addColumn($column_humpagina);
