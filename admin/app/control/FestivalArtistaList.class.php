 ...
 */
class FestivalArtistaList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->addQuickAction('Adicionar Artista', new TAction(array($this, 'onSearch')), 'fa:save green');
        ...
        $column_artfoto = new TDataGridColumn('artfoto', 'Imagem', 'left',80);
    ...
    public function onSearch($param)
    {
       TTransaction::open('conexao');
        ...
        $festival->addArtistaSave($param['artcodigo']);
       TTransaction::close();
       $this->onReload();
    }
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            if( $festival->getArtistas() ) {
                ...
                foreach ($festival->getArtistas() as $object)
                {
            ...
            $count= sizeof($festival->getArtistas());
    ...
    public function onDelete($param)
    {
        TTransaction::open('conexao');
        $festival =  new Festival(TSession::getValue('fescodigo'));
        $festival->removeArtistaSave($param['artcodigo']);
       TTransaction::close();
       $this->onReload();
    }
