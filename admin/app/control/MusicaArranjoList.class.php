 ...
 */
class MusicaArranjoList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Artista (ARRANJO) -  Música: <b><span id="musnome"><span></b>');
        ...
        $this->form->addQuickAction('Adicionar Arranjador', new TAction(array($this, 'onSearch')), 'fa:save green');
 ...
 // criar na grade um ordenação nome
        ...
        $container->add(TPanelGroup::pack('Artista (ARRANJO) -  Música: <b><span id="musnome"><span></b>', $this->form));
