                ...
                <div class="artistas-container row">
                    <div class="large-12 columns" style=" padding: 10px;">
                        <table class="table">
                            ...
                            $festivais = (new Festival())->getFestivaisCinema($codigo);
                            $tm = sizeof($festivais);
                            if ($tm < 1)
                                continue;
                            ?>
                                        ...
                                        <td>
                                            ...
                                            <aside class="widget group"
                                                ...
                                                <figure class="event-thumb" style="margin: 0px;">
                                                    <a href="?p=festival-cinema-detalhe&id=<?= $festival->fescodigo ?>"
