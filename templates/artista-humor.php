        ...
        <div class="large-12 columns">
            ...
            <article class="post group">
                ...
                <header class="entry-top special-top">
                    <h1 class="entry-title page-title">A Arte de <a href="#"><?=  $artista->artusual ?>.</a> Humor</h1>
                </header>
        ...
        <br/>
          ...
          $bandas = $artista->getBandas();
            ...
            <article class="post group" style="margin-top:-20px;">
                ...
                $festivais = $festival->getFestivaisHumor();
            ...
            <article class="post group" style="margin-top:-20px;">
                    <div class="entry-content">
                        <h3>Catálogo de Humor de <a href="#"><?= $artista->artusual ?></a></h3>
                                        ...
                                        <ol class="tracklisting">
                                            ...
                                            if ($humors):
                                                foreach ($humors as $humor):
                                                    ...
                                                    $artistaHumor = $humor->getArtista();
                                                    if ($artistaHumor->artcodigo != $artista->artcodigo) continue;
                                                    ...
                                                    <li class="large-3 columns"style="margin-top:5px; padding-left: 0px; text-align: center; max-height: 380px; min-height: 350px;" >
                                                        <a target="_blank" href="livro.php?livcodigo=<?=$livro->livcodigo?>#page/<?=$paginaLivro->numero?>"  title="Ir para o Catalogo:  <?= $humor->humnome ?> ">
