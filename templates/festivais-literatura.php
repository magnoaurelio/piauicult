                ...
                <div class="artistas-container row">
                    <div class="large-12 columns" style=" padding: 10px;">
                        <table class="table">
                            ...
                            $festivais = (new Festival())->getFestivaisLiteratura($precodigo);
                            $tm = sizeof($festivais);
                            if ($tm < 1)
                                continue;
                            ?>
                            <tr class="group track">
                                ...
                                <td style="margin-right: 10px; text-align: center;  ">
                                   <h5 class="track-title"> <a href="?p=cidade&id=<?= $precodigo; ?>"><?= $cidade->prenome; ?>&nbsp;</a></h5>
                                        <table border="1">
                                            ...
                                            <aside class="widget group"
                                                   style="width: 200px; height:250px; margin-right: 5px; margin-bottom:20px;">
                                                    <figure class="event-thumb" style="margin: 0px;">
                                                        <a href="?p=festival-literatura-detalhe&id=<?= $festival->fescodigo ?>"
                                                ...
                                                <a style="text-align: center;"
                                                   href="?p=festival-literatura-detalhe&id=<?= $festival->fescodigo ?>"
