        ...
        <div class="large-12 columns">
            ...
            <article class="post group">
                ...
                <header class="entry-top special-top">
                    <h1 class="entry-title page-title">A Arte de <a href="#"><?= $artista->artnome ?>.</a> Cinema</h1>
                </header>
                <div class="entry-content row">
                    <div class="large-9 columns">
                        ...
                        <ul  style="list-style: none">
                            ...
                            <li >
                                <a class="fa fa-home"></a>
                                 <li><h3>Sobre:</h3><span style="width: 100%;"><?=$artista->artbiografia ?></span></li>
        ...
        <br/>
          ...
          $bandas = $artista->getBandas();
            ...
            <article class="post group">
                ...
                $festivais = $festival->getFestivaisCinema();
                        ...
                        <div class="large-2 columns sidebar sidebar-1">
                            <aside class="widget group" style="padding: 0px;  margin-bottom: 10px;">
                                <ol class="widget-list widget-list-single" > <!--tracklisting tracklisting-top- numeração-->
                                    ...
                                    <li  style="max-height: 200px; min-height: 200px; margin: 0px;">

                                        <table width="100%" border="0">
                                            <tr>
                                                <td  width="65">
                                                    <a href="?p=festival-detalhe&id=<?= $festivalObject->fescodigo; ?>" class="" title="<?= $festivalObject->fesnome; ?>"><img src="admin/files/festivais/<?=trim($festivalObject->fesimagem);?>" width="100" alt="" /></a>
                                                </td>

                                            </tr>
                                        </table>
                                        <p style="font-size:14px; margin-top: 0; padding: 0;" class="track-title"><a href="?p=festival-detalhe&id=<?= $festivalObject->fescodigo; ?>"><?= $festivalObject->fesnome; ?></a></p>
            ...
            <article class="post group">
                    <div class="entry-content">
                        <h3>Catálogo de Cinemas de <a href="#"><?= $artista->artnome ?></a></h3>
                        <?php if ($festivaisQueArtistaParticipa): ?>
                        <table style="width: 100%">
                            <?php foreach ($festivaisQueArtistaParticipa as $codigo):
                                $festival = new Festival($codigo);
                                        ...
                                        <ol class="tracklisting">
                                            ...
                                            if ($cinemas):
                                                foreach ($cinemas as $cinema):
                                                    ...
                                                    $fotocinema = "admin/files/cinema/" . trim($cinema->cinimagem);
                                                    $elenco = $cinema->getElenco();

                                                    $participa = false;

                                                    if ($elenco){
                                                        foreach ($elenco as $art){
                                                            if ($art["artcodigo"] == $artista->artcodigo){
                                                                $participa = true;
                                                                break;
                                                            }
                                                        }
                                                    ...
                                                    // var_dump($fesmostra);
                                                    ?>
                                                    <li class="large-3 columns"style="margin-top:5px; padding-left: 0px; text-align: center; max-height: 360px; min-height: 350px;" >
                                                        <a  href="?p=cinema-detalhe&id=<?=$cinema->cincodigo?>"  title="Ir para o Catalogo:  <?= $cinema->cinnome ?> ">
                                                            <img src="<?= $fotocinema ?>" width="200"/><br>
                                                        ...
                                                        <h5 class="list-subtitle" style="margin-bottom: 3px; letter-spacing: 0.05px; font-size: 16px !important; font-weight: 600 !important;">
                                                            <a href="?p=cinema-detalhe&id=<?=$cinema->cincodigo?>"  title="Ir para o Cinema:  <?= $cinema->cinnome ?> ">
                                                                <?= $cinema->cinnome?>
                                                            </a> <br>
                                                            <a href="?p=cinema-detalhe&id=<?=$cinema->cincodigo?>"   title="Ir para o Cinema:  <?= $cinema->cinnome ?> ">
