        ...
        <div class="large-9 columns" >
            ...
            <article class="post group">
                ...
                <header class="entry-top special-top">
                    <h1 class="entry-title page-title"><img src="<?= $imgp ?>" width="100" />&nbsp;A Arte de (<?= $artista->artusual ?>) Discografia.
            ...
            <article class="post group" style="margin-top: -30px">
                ...
                <div class="entry-content">
                    <h3><img src="images/piauicult.jpg" width="80" alt="" />Discos gravados (<?=$artista->artusual?>)&nbsp;<img src="<?= $imgp ?>" width="80" alt="" /></h3>				
            ...
            <aside class="widget group">
               ...
               <aside class="widget group">
                <h3 class="widget-title"><?= $artista->artusual ?> na WEB</h3>
                 ...
                 <iframe width="100%" height="450" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/users/<?=$artista->artsound?>
                         &amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true">
                 </iframe>
                 <?php endif; ?>

                <?php if ($artista->artfacebook): ?>
                    <div class="fb-page" data-href="<?= $artista->artfacebook ?>" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                        <blockquote cite="<?= $artista->artfacebook ?>" class="fb-xfbml-parse-ignore">
                            <a href="<?= $artista->artfacebook ?>"><?= $artista->artusual ?></a>
                        </blockquote>
                    </div>
                 <?php endif; ?>
                
                <?php if ($artista->artsound): ?>
                    <div class="fb-page" data-href="<?= $artista->artsound ?>" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                        <blockquote cite="<?= $artista->artsound ?>" class="fb-xfbml-parse-ignore">
                            <a href="<?= $artista->artsound ?>"><?= $artista->artusual ?></a>
                        </blockquote>
                    </div>
                 <?php endif; ?>
