...
<aside class="widget group" style="margin-top: -30px">
    <?php
    $artistas = new Read();
    $artistas->ExeRead("artista", "WHERE arttipocodigo = 5 ORDER BY rand() limit 1");
    
    ?>
    <ol class="widget-list">
     <h4 class="widget-title"><a href="?p=artists">Intérpretes</a></h4>
    ...
    <li>
        ...
        <h5 class="list-subtitle"><?=$artista_tipo['arttiponome']?></h5>
         ...
         <a  href="?p=artist&id=<?=$artista['artcodigo']?>" class="action-btn" title="Mais sobre... <?=$artista['artusual']?>">Veja Artista</a>
    </li>
     <?php  
        endif;
       endforeach;
