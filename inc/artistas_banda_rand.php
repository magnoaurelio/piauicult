	...
	<?php
	$artistas = new Read();
	$artistas->ExeRead("artista", "WHERE arttipocodigo = 17 or arttipocodigo = 19 ORDER BY rand() limit 1");
	
	?>
	<ol class="widget-list">
	<h4 class="widget-title"><a href="?p=artists">Orquestra e Banda Musicais</a></h4>
